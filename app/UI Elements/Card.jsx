...
export default function Card({ imageUrl, title, price, badgeText, badgeColor, badgeBgColor,onclick }) {
  return (
    <div onClick={onclick} className="w-[153px]   md:w-[295px] flex flex-col justify-start gap-[10px] items-center">
      <div className="relative cursor-pointer  w-[153px] h-[153px] md:w-[295px] md:h-[263px] ">
        <Image
